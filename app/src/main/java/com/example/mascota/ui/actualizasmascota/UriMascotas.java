...
public class UriMascotas {
    ...
    public UriMascotas(String Nombre, String Imagen_perfil, String Especie, String FechaNacimiento, String Color, String NumeroHistoriaClinica, String Raza, String Sexo) {
        this.Nombre = Nombre;
